...
export default function TodoListControllers() {
  const adminOptions = [
    {
      title: "Add Task List",
      description: "Upload a new list of tasks to be completed.",
      image:
        "https://images.pexels.com/photos/3184632/pexels-photo-3184632.jpeg",
    },
    {
      title: "View Task Lists",
      description: "See all task lists and check their progress.",
      image:
        "https://images.pexels.com/photos/3184632/pexels-photo-3184632.jpeg",
    },
  ];
  ...
  const onclick = (title) => {
    if (title == "Add Task List") {
      navigate("/todo_list/management");
